"""Local integration smoke for Telegram pairing, group identities and reassignment."""
...
def main() -> None:
    ...
    with httpx.Client(base_url=BASE, timeout=30) as client:
        ...
        try:
            students = client.get("/workspace/students", params={"scope": "all"}).json()["items"]
            require(len(students) >= 2, "two students available for reassignment")
            first_student = students[0]["student"]["id"]
            second_student = students[1]["student"]["id"]
