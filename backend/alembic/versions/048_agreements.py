...
def upgrade() -> None:
    agreement_audience = sa.Enum("mentor", "student", "mzk", name="agreement_audience")
    agreement_status = sa.Enum("draft", "published", "archived", name="agreement_status")
    ...
    op.create_index(
        "ix_agreement_signatures_user_agreement",
        "agreement_signatures",
