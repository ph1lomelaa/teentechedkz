...
describe('resolveDrop', () => {
  ...
  it('не снимает ответственного перетаскиванием в «без ответственного»', () => {
    // Снятие — не то же самое, что передача: оно делается из карточки студента
    // осознанно, а случайный промах в первую колонку оставил бы ученика ничьим.
    expect(resolveDrop(board, 's1', UNASSIGNED_COLUMN)).toBeNull()
  })
