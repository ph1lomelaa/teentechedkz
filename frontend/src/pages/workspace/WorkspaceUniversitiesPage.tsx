...
export const WorkspaceUniversitiesPage: React.FC = () => {
  const { can } = useAuth()
  return <UniversitiesCatalog eyebrow="Кабинет ментора" basePath="/workspace/universities" canManage={can('universities', 'manage')} canImport={can('universities', 'create')} />
}
